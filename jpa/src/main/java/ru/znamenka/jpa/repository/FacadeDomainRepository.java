...
import ru.znamenka.jpa.util.Utils;
 ...
 * <p>
 * Экземпляры репозиториев хранятся в так называемой корзинке репозиториев BeanBucketConfig#repositoryBucket().
...
public class FacadeDomainRepository implements EntityRepository {
     ...
     *
     * BeanBucketConfig#repositoryBucket()
     */
