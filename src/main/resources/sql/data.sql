...
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (1, 'Абонемент(ЭМС) 8', 28000, 8, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (2, 'Абонемент(ЭМС) 16', 51850, 16, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (3, 'Абонемент(ЭМС) 24', 71280, 24, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (4, 'Абонемент(ЭМС) 48', 129000, 24, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (5, 'Абонемент-парный(ЭМС) 8', 44800, 8, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (6, 'Абонемент-парный(ЭМС) 16', 82800, 16, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (7, 'Абонемент-парный(ЭМС) 24', 114000, 24, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (8, 'Абонемент-парный(ЭМС) 48', 258000, 48, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (9, 'Пробная тренировка', 1700, 1, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (10, 'Разовая тренировка', 3600, 1, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (11, 'УСТАРЕВШИЙ Абонемент(ЭМС) 10', 26900, 10, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (12, 'УСТАРЕВШИЙ Абонемент(ЭМС) 20', 45900, 20, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (13, 'УСТАРЕВШИЙ Абонемент(ЭМС) 50', 89900, 50, 360, 1, 1);
INSERT INTO public.products (product_id, product_name, price, training_count, expire_days, abon_type, is_abon) VALUES (14, 'Протеиновый коктель с бананом', 350, null, null, null, 0);
